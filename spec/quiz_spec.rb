...
describe "a quiz" do
  ...
  it "should find the largest number and second largest number" do
  ...
  it "should return the average of the 2 or 3 numbers in the middle of the array" do
    ...
    expect(average_median([9, 8, 2, 4, 7])).to eq(4.66)
  end

  # it "returns true if you can split the array into parts where the sum of one portion equals the sum of the other portion" do
  #   expect(can_balance([1, 2, 1, 1, 1])).to eq(true)
  #   expect(can_balance([2, 1, 1, 2, 1])).to eq(false)
